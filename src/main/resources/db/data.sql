...
INSERT INTO order_lines (id, order_id, order_return_id, product, quantity, line_weight, product_price, line_price)
VALUES
    ('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', NULL, '44444444-4444-4444-4444-444444444444', 2, 1.5, 20.00, 40.00);

INSERT INTO order_lines (id, order_id, order_return_id, product, quantity, line_weight, product_price, line_price)
VALUES
    ('22222222-2222-2222-2222-222222222222',NULL, '33333333-3333-3333-3333-333333333333', '55555555-5555-5555-5555-555555555555', 1, 2.0, 30.00, 30.00);
